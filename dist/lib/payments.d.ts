...
import { Dictionary, IAmount, IMolliePaymentListResult, IPaymentsListOptions } from "../Types";
...
export default class MolliePayments {
     ...
     */
    create: (amount: IAmount, description: string, redirectUrl: string, options?: Dictionary | undefined, lang?: string | undefined) => Promise<Error | Payment>;
    /**
     ...
     */
    get: (id: string) => Promise<Error | Payment>;
    /**
     ...
     */
    list: (options?: IPaymentsListOptions | undefined) => Promise<Error | IMolliePaymentListResult>;
}
