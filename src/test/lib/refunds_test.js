...
describe('Refunds', () => {
    ...
    before(async () => {
        ...
        try {
            const payments_list = await mollieOne.payments.list();
    ...
    describe('.create', () => {
        ...
        describe('Errors', () => {
            it('An Object should be thrown', async () => {
                try {
                    await mollieOne.refunds.create();
                    check = 1;
                } catch (error) {
            ...
            it('Should throw an error if id amount is given', async () => {
                try {
                    await mollieOne.refunds.create();
                    check = 1;
                } catch (error) {
            ...
            it('Should throw an error if no valid id is given', async () => {
                try {
                    await mollieOne.refunds.create('invalidId');
                    check = 1;
                } catch (error) {
                    error.should.have.property('error');
                    check = 2;
    ...
    describe('.get', () => {
        ...
        describe('Errors', () => {
            ...
            it('Should throw an error if no paymentId is given', async () => {
                try {
                    await mollieOne.refunds.get(null, 'someId');
                    check = 1;
                } catch (error) {
            ...
            it('Should throw an error if no refundId is given', async () => {
                try {
                    await mollieOne.refunds.get('someId', null);
                    check = 1;
                } catch (error) {
                    error.should.have.property('error', 'No paymentId or refundId is given');
                    check = 2;
            ...
            it('Should throw an error if no valid ids are given', async () => {
                try {
                    await mollieOne.refunds.get('invalidId', 'invalidId');
                    check = 1;
                } catch (error) {
                    error.should.have.property('error');
                    check = 2;
    ...
    describe('.list', () => {
        ...
        describe('Errors', () => {
            it('Should throw an error if no id is given', async () => {
                try {
                    await mollieOne.refunds.list(null, {count: 251});
                    check = 1;
                } catch (error) {
            ...
            it('Should throw an error if a count of more than 250 is given', async () => {
                try {
                    await mollieOne.refunds.list('someId', {count: 251});
                    check = 1;
                } catch (error) {
            ...
            it('Should throw an error if no valid id is given', async () => {
                try {
                    await mollieOne.refunds.list('invalidId');
                    check = 1;
                } catch (error) {
                    error.should.have.property('error');
                    check = 2;
    ...
    describe('.cancel', () => {
        ...
        describe('Errors', () => {
            it('An Object should be thrown', async () => {
                try {
                    await mollieOne.refunds.cancel();
                    check = 1;
                } catch (error) {
                    error.should.be.an.Object();
                    error.should.have.property('error');
            ...
            it('Should throw an error if no paymentId is given', async () => {
                try {
                    await mollieOne.refunds.cancel(null, 'someId');
                    check = 1;
                } catch (error) {
                    error.should.have.property('error', 'No paymentId or refundId is given');
                    check = 2;
            ...
            it('Should throw an error if no refundId is given', async () => {
                try {
                    await mollieOne.refunds.cancel('someId', null);
                    check = 1;
                } catch (error) {
                    error.should.have.property('error', 'No paymentId or refundId is given');
                    check = 2;
            ...
            it('Should throw an error if no valid id is given', async () => {
                try {
                    await mollieOne.refunds.cancel('invalidId', 'invalidId');
                    check = 1;
                } catch (error) {
                    error.should.have.property('error');
                    check = 2;
