...
describe('Customers', () => {
    ...
    describe('.create', () => {
        ...
        describe('Errors', () => {
            it('An Object should be thrown', async () => {
                try {
                    await mollieOne.customers.create();
                    check = 1;
                } catch (error) {
            ...
            it('Should throw an error if no name is given', async () => {
                try {
                    await mollieOne.customers.create(null, email);
                    check = 1;
                } catch (error) {
            ...
            it('Should throw an error if no email is given', async () => {
                try {
                    await mollieOne.customers.create(name, null);
                    check = 1;
                } catch (error) {
                    error.should.have.property('error', 'Not all required parameters are given');
                    check = 2;
            ...
            it('Should throw an error if a non-accepted locale is set', async () => {
                try {
                    await mollieOne.customers.create(name, email, {locale: 'dutch'});
                    check = 1;
                } catch (error) {
                    error.should.have.property('error');
                    check = 2;
        ...
        describe('Success', () => {
            it('Should return an Object', async () => {
                try {
                    const customer = await mollieOne.customers.create(name, email);
    ...
    describe('.get', () => {
        ...
        describe('Success', () => {
            it('Should return an Object', async () => {
                try {
                    const customer = await mollieOne.customers.get(customer_id);
                    customer.should.be.an.Object();
                    check = 1;
                } catch (error) {
                    console.log(error);
    ...
    describe('.list', () => {
        ...
        describe('Errors', () => {
            it('Should throw an error if a count of more than 250 is given', async () => {
                try {
                    await mollieOne.customers.list({count: 251});
                    check = 1;
                } catch (error) {
        ...
        describe('Success', () => {
            it('Should return an Object', async () => {
                try {
                    const customers_list = await mollieOne.customers.list({count: 15});
            ...
            it('Should work without parameters', async () => {
                try {
                    const customers_list = await mollieOne.customers.list();
