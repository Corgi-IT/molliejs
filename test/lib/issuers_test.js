...
describe('Issuers', () => {
    ...
    describe('.list', () => {
        ...
        describe('Errors', () => {
            it('Should throw an error if a count of more than 250 is given', async () => {
                try {
                    await mollieOne.issuers.list({count: 251});
                    check = 1;
                } catch (error) {
        ...
        describe('Success', () => {
            it('Should return an Object', async () => {
                try {
                    const issuers = await mollieOne.issuers.list({count: 15});
    ...
    describe('.get', () => {
        ...
        describe('Success', () => {
            it('Should return an Object', async () => {
                try {
                    const issuer = await mollieOne.issuers.get(issuer_id);
